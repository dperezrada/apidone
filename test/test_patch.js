...
describe('Parallel update', function(){
	before(function(done){
		movies = [
			{id:1, 'name': 'The Matrix 1', 'year': 1998, 'language': 'english 1'},
			{id:2, 'name': 'The Matrix 2', 'year': 1998, 'language': 'english 2'},
			{id:3, 'name': 'The Matrix 3', 'year': 1998, 'language': 'english 3'},
			{id:4, 'name': 'The Matrix 4', 'year': 1998, 'language': 'english 4'},
			{id:5, 'name': 'The Matrix 5', 'year': 1998, 'language': 'english 5'},
			{id:6, 'name': 'The Matrix 6', 'year': 1998, 'language': 'english 6'},
			{id:7, 'name': 'The Matrix 7', 'year': 1998, 'language': 'english 7'}
		];
		async.series([
			function(callback){
				async.series(
