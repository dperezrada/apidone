...
var BSON, Db, MONGODB_DBNAME, MONGODB_HOST, MONGODB_PORT, Mongo, PORT, SALT, Server, app, async, aws, check_subdomain, configure_app, crypto, db, encrypt_pass, express, formatErrorHandler, fs, get_extension, mongodb, path, send_email, server, set_cors, _;
...
check_subdomain = function(collection, subdomain, callback) {
  return collection.findOne({
    ...
    if (err) {
      ...
      return callback(null, 'Must have length of 10 or more');
    } else {
