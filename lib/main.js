...
var BSON, Db, MONGODB_DBNAME, MONGODB_HOST, MONGODB_PORT, Mongo, PORT, Server, app, async, clear_response, configure_app, create_internal_url, db, express, formatErrorHandler, get_extension, get_limit, get_prefix_interal_url, get_skip, get_sort, mongodb, prepare_db_filters, retrieve_collection, retrieve_subdomain, server, set_cors, _;
...
get_extension = function(req, res, next) {
